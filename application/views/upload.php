...
<body leftmargin="0" marginwidth="0" topmargin="0" marginheight="0" offset="0" bgcolor="" class="background">
 <form class="well form-horizontal" action="<?php  echo base_url('Uploadcsv/import');?> " method="post"  id="contact_form" enctype="multipart/form-data">
                      ...
                      <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff">
                        ...
                        <tr>
                          <td>
                            ...
                            <tr>
                              <td align="center" style="padding:107px 426px;">
                                <center>
                                          ...
                                          <tr>
                                            <td>
                                              <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff">
                                                ...
                                                <tr>
                                                  <td width="150" class="data-heading">
                                                    <button type="submit"  name="import" value="Register" id="Register" class="btn btn-primary">Submit</button>								
